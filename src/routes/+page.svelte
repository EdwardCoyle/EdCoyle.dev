        ...
        <div class="content-area-container relative md:mx-auto lg:mx-0 md:max-w-680 lg:max-w-none">
            ...
            <section id="about" aria-label="About" class="scroll-mt-0">
                ...
                <ContentCard>
                    ...
                    <p class="mb-8 text-md">Today, I’m focused on building user experiences that feel polished, expressive, and practical.  Currently, I'm helping to implement best practices for Angular applications on the Resource Advisor Plus platform at <a class="link" href="https://www.se.com/us/en/">Schneider Electric</a>.  In a recent role, I built the <a class="link" href="https://design.infor.com/">Infor Design System</a>, helping turn a large portion of the system into TypeScript-based Web Components used across the company’s application teams.</p>
