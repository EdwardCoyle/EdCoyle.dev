        ...
        <div class="lg:p-8">
            ...
            <section class="m-4 p-4 min-h-96 max-w-640 lg:w-640 bg-cardBg" id="work" aria-label="Work Experience">
                ...
                <ContentGrid>      
                    ...
                    <ContentGridMain>
                        <h3><a href="#work-schneider">Schneider Electric</a></h3>
                    ...
                    <ContentGridMain>
                        <h3><a href="#work-infor">Infor, Inc.</a></h3>
                    ...
                    <ContentGridMain>
                        <h3><a href="#work-connexin">Connexin Software, Inc. (Office Practicum)</a></h3>
